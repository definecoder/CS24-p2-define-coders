      ...
      <Container className="flex flex-wrap">
        <div className="flex items-center w-full lg:w-[60%]">
          <div className="max-w-2xl mb-8 ml-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              Join us in Building a Cleaner, Greener Dhaka - Innovating
              Solutions for Sustainable Waste Management, Enhancing Public
              Health, and Preserving Our Environment for Generations to Come
            </p>
        ...
        <div className="flex items-center justify-center w-full lg:w-[40%]">
          <div className="w-[616px] h-[616px]">
            <Image src="/hero.png" alt="N" width="616" height="616" />
          </div>
        </div>
      </Container>
    </>
