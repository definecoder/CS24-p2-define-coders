    ...
    <>
      {scheduleData[0] ? (
        <div className="flex flex-col items-center justify-center w-full text-center">
          <h1 className="font-bold text-2xl">EcoSync</h1>
        ...
        <EmptyFillContainer className="flex justify-center items-center text-2xl font-bold text-center flex-col gap-5 min-h-96">
          No schedule generated by Admin for {stsName} on {date}.
          {getCookie(role) === admin && <Button> Generate Schedule </Button>}
        </EmptyFillContainer>
      )}
    </>
  );
