...
const IssueCard : React.FC<IssueCardProps> = ({ issueType, description, latitude, longitude, isAnonymous }) => {
  return (
  ...
  <div className="flex items-center">
    ...
    <h3 className="text-lg font-medium">Issue info type: {issueType}</h3><br/>
    <p className="text-lg font-medium">Location: {latitude} {longitude}</p>
  </div>
